...
class ContinueCommandTest {
    ...
    @Mock private QuestService mockQuestService;

    @Mock private UserSession mockUserSession;

    @Mock private Quest mockQuest;
    ...
    void testCommandCreation() {
        ...
        assertEquals(
                "Continue your current quest or resume progress", continueCommand.getDescription());
    }
    ...
    void testExecuteWithQuestServiceException() {
        ...
        String questId = "quest-123";
        when(mockUserSession.getCurrentQuestId()).thenReturn(questId);
        when(mockQuestService.getQuestById(questId))
