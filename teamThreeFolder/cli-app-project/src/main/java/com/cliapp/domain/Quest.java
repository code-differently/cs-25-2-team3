...
/**
 * Quest domain object that holds learning modules with difficulty and completion status
 * SOLID: Single Responsibility - represents a quest with learning modules
 */
public class Quest {
    ...
    public Quest(String id, String name, String description, List<String> learningModules, int difficultyLevel) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.learningModules = learningModules != null ? new ArrayList<>(learningModules) : new ArrayList<>();
    ...
    public String getDifficultyAsAsterisks() {
        // TODO: Implement - return "*", "***", or "*****" based on difficultyLevel
        return null;
    }
    ...
    public String getCompletionStatus() {
        // TODO: Implement - return "Y" or "N" based on isCompleted
        return null;
    }
